...
<b>✯ Cʀᴇᴀᴛᴏʀ : <a href=https://t.me/Scooby_Men>☢ Tʜᴇ Oᴡɴᴇʀ ☢</a></b>
<b>✯ Uᴘᴅᴀᴛᴇs : <a href=https://t.me/theottservice> Uᴘᴅᴀᴛᴇs 👾</a></b>
...
Wᴀɴᴛ ᴛʜɪs Bᴏᴛ Rᴇᴘᴏ? <b>🙃</b>

Mᴏʀᴇ Iɴғᴏ Aʙᴏᴜᴛ ᴛʜɪs Rᴇᴘᴏ - <a href='https://t.me/theottservice'>ᴅᴏᴜʙʟᴇ ᴛᴀᴘ</a></b>
"""
...
ᴘʟᴇᴀꜱᴇ ᴄʜᴇᴄᴋ ᴛʜᴇ ꜱᴘᴇʟʟɪɴɢ ᴏɴ ɢᴏᴏɢʟᴇ ᴏʀ ɪᴍᴅʙ..."""
    ...
    SHORTLINK_INFO = """
<b>──────「<a href=https://t.me/theottservice> Hᴏᴡ ᴛᴏ Eᴀʀɴ Mᴏɴᴇʏ </a> 」──────
...
sᴛᴇᴘ 𝟸 : ᴍᴀᴋᴇ ᴀᴄᴄᴏᴜɴᴛ ᴏɴ Aɴʏ <a href=https://onepagelink.in/ref/HarshaMp4>Sʜᴏʀᴛᴇɴᴇʀ Wᴇʙsɪᴛᴇ</a>.

sᴛᴇᴘ 𝟹 : ꜰᴏʟʟᴏᴡ ᴛʜᴇsᴇ ɪɴꜱᴛʀᴜᴄᴛɪᴏɴꜱ Tᴏ ᴄᴏɴɴᴇᴄᴛ sʜᴏʀᴛᴇɴᴇʀ.

➣ Yᴏᴜ ᴄᴀɴ ᴄᴏɴɴᴇᴄᴛ ᴀs ᴍᴀɴʏ ɢʀᴏᴜᴘ ʏᴏᴜ ʜᴀᴠᴇ.
———————————————————
<b>Fᴏʟʟᴏᴡ Tʜᴇsᴇ Sᴛᴇᴘs:

𝟷. Mᴀᴋᴇ Sᴜʀᴇ Yᴏᴜʀ Gʀᴏᴜᴘ Hᴀs 𝟷𝟶𝟶+ Mᴇᴍʙᴇʀs!!!

𝟸. Aᴅᴅ Bᴏᴛ ᴛᴏ Yᴏᴜʀ Gʀᴏᴜᴘ ᴡɪᴛʜ Fᴜʟʟ Aᴅᴍɪɴ Rɪɢʜᴛs

𝟹. Aғᴛᴇʀ Aᴅᴅɪɴɢ ɪɴ Gʀᴘ, Cʀᴇᴀᴛᴇ Aᴄᴄᴏᴜɴᴛ ɪɴ ᴀɴʏ Sʜᴏʀᴛᴇɴᴇʀ Wᴇʙsɪᴛᴇ

𝟺. Sᴇɴᴅ ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ</b>

—> /shortlink {your_shortener_website_name} {your_shortener_api}

#Sᴀᴍᴘʟᴇ:-
<blockquote>/shortlink onepagelink.in 364b42a30127f8cb7e2c10664975bdd26d2be0a2</blockquote>

<b>𝟻. Aᴅᴅ Mᴏʀᴇ Mᴇᴍʙᴇʀs Tᴏ Eᴀʀɴ Mᴏʀᴇ Mᴏɴᴇʏ

𝟼. Tʜᴀᴛ's ɪᴛ!!! Eɴɪᴏʏ Eᴀʀɴɪɴɢ Mᴏɴᴇʏ 💲💸
———————————————————

𝐁𝐨𝐭 𝐅𝐞𝐚𝐭𝐮𝐫𝐞𝐬:-

𝟷. 𝟻Lᴀᴋʜ+ Mᴏᴠɪᴇs (Nᴇᴡ ᴍᴏᴠɪᴇs ᴜᴘᴅᴀᴛᴇᴅ ᴅᴀɪʟʏ).

𝟸. Eᴀʀɴ ᴍᴏɴᴇʏ ʙʏ ᴄᴏɴɴᴇᴄᴛɪɴɢ ʏᴏᴜʀ ᴏᴡɴ sʜᴏʀᴛᴇɴᴇʀ.

𝟹. Yᴏᴜ ᴄᴀɴ ᴀʟsᴏ ᴀᴅᴅ ʏᴏᴜʀ ᴄᴜsᴛᴏᴍ ᴛᴜᴛᴏʀɪᴀʟ ʟɪɴᴋ ᴜsɪɴɢ /sᴇᴛ_ᴛᴜᴛᴏʀɪᴀʟ ᴄᴏᴍᴍᴀɴᴅ </b>

<blockquote>/set_tutorial https://t.me/Team_HMT/8</blockquote>
———————————————————
